...
class Tests(unittest.TestCase):
    ...
    def test_type_check_ids(self):
        ...
        l2 = [1, 2, 3, 4, 5, 6, 2, 9]
        self.assertEqual(type_checker.check_ids(l2), ["There are duplicate ids: [2]"])
    ...
    def test_type_dependencies(self):
        ...
        self.assertEqual(type_checker.check_dependencies(d2), [])

        d3 = {1: {0,2,3,4}, 2: {1,2}}
        self.assertEqual(type_checker.check_dependencies(d3), ["2 is dependent on itself"])
