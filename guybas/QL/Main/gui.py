...
class QuestionnaireGUI:
    def __init__(self, form):
        ...
        self.elementsMap = {}  # structure: {parent_id: {pointsTo:List, statements:List, guiElements:List} .. }
    ...
    def draw_statements(self, statements):
        ...
        for statement in statements:
            ...
            if parent_id not in self.elementsMap:
                self.elementsMap[parent_id] = {'pointsTo': [], 'statements': [], 'guiElements': []}
            print(parent_id)
    ...
    def update(self, question, new_answer):
        ...
        print(new_answer)
        if question.get_parent_id() is not None:  # None = not conditional
            self.elements_recreate(question.get_parent_id())
    ...
    def elements_recreate(self, parent_id):
        ...
        self.draw_statements(self.elementsMap[parent_id]['statements'])
