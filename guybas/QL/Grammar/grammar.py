...
answerR = (pp.Literal(constants.BOOL).setParseAction(lambda x: bool) |
           pp.Literal(constants.NUMBER).setParseAction(lambda x: int) |
           pp.Literal(constants.TEXT).setParseAction(lambda x: str))
