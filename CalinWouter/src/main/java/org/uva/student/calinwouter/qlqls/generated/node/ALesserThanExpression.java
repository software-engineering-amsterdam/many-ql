...
public final class ALesserThanExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public ALesserThanExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALesserThanExpression(
    ...
    {
        ((Analysis) sw).caseALesserThanExpression(this);
    }
