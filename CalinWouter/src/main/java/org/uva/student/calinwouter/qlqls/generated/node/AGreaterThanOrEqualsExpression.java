...
public final class AGreaterThanOrEqualsExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public AGreaterThanOrEqualsExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGreaterThanOrEqualsExpression(
    ...
    {
        ((Analysis) sw).caseAGreaterThanOrEqualsExpression(this);
    }
