...
public class Fields {
    ...
    public void render(JPanel sectionPanel, QLSRenderParameters qlsRenderParameters) {
        for (AbstractFormField abstractFormField : fields) {
            final Component renderedComponent = abstractFormField.render(qlsRenderParameters);
