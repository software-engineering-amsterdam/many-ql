...
public final class ALesserThanOrEqualsExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public ALesserThanOrEqualsExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALesserThanOrEqualsExpression(
    ...
    {
        ((Analysis) sw).caseALesserThanOrEqualsExpression(this);
    }
