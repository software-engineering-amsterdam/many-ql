...
public final class ANotEqualsExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public ANotEqualsExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANotEqualsExpression(
    ...
    {
        ((Analysis) sw).caseANotEqualsExpression(this);
    }
