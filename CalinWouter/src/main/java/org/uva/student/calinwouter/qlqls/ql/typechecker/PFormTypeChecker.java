...
public class PFormTypeChecker extends AnalysisAdapter {
    ...
    public PFormTypeChecker(StaticFieldsList staticFieldsList, TypeCheckResults typeCheckResults) {
        this.pExpTypeChecker = new PExpTypeChecker(staticFieldsList, typeCheckResults);
    }
}
