...
import org.uva.student.calinwouter.ql.interpreter.exceptions.CastException;
...
public abstract class TypeModel<T> {
    ...
    /**
     * Empty constructor TypeModel is used for TypeChecking.
     */
    public TypeModel() { value = null; }
