...
public class qlGrammarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements qlGrammarVisitor<T> {
	@Override public T visitBigger(qlGrammarParser.BiggerContext ctx) { return visitChildren(ctx); }

	@Override public T visitBiggerEq(qlGrammarParser.BiggerEqContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitSmaller(qlGrammarParser.SmallerContext ctx) { return visitChildren(ctx); }

	@Override public T visitMultiply(qlGrammarParser.MultiplyContext ctx) { return visitChildren(ctx); }

	@Override public T visitId(qlGrammarParser.IdContext ctx) { return visitChildren(ctx); }

	@Override public T visitFalse(qlGrammarParser.FalseContext ctx) { return visitChildren(ctx); }

	@Override public T visitAdd(qlGrammarParser.AddContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitDivide(qlGrammarParser.DivideContext ctx) { return visitChildren(ctx); }

	@Override public T visitSub(qlGrammarParser.SubContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitTrue(qlGrammarParser.TrueContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitSmallerEq(qlGrammarParser.SmallerEqContext ctx) { return visitChildren(ctx); }

	@Override public T visitBoolType(qlGrammarParser.BoolTypeContext ctx) { return visitChildren(ctx); }

	@Override public T visitBoolId(qlGrammarParser.BoolIdContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitBolexp(qlGrammarParser.BolexpContext ctx) { return visitChildren(ctx); }
