...
*/
		...
		for (Question question : questions){
			...
			if (question instanceof IfQuestion){
				...
				if (question.isComputed()){
					...
					//if not null:
					jtxt.setText("" + cq.arithmeticExpr.accept(new BooleanExpressionEvaluationVisitor(tempVarsColl2)));
				}
				gbc.gridy++;
			}
		}		
	...
	static void processIfQuestion(Question question){
		...
		if ((((IfQuestion)question).boolExpr).accept(new BooleanExpressionEvaluationVisitor(tempVarsColl2)) == false){
