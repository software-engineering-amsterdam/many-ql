...
import nl.uva.bromance.QL.expressions.binary.arithmetic.Division;
import nl.uva.bromance.QL.expressions.binary.arithmetic.Multiplication;
import nl.uva.bromance.QL.expressions.binary.arithmetic.Subtraction;
...
public class QLParseTreeListener extends QLBaseListener
{
    ...
    {
        Else _else = new Else(getLine(ctx));
