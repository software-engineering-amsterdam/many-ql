 ...
 * @author Pim Tegelaar
 */
public class TestRigGuiQL extends JFrame implements ActionListener {

	private static final String TMPFILE_TXT = "tmpfile.txt";

	private static final long serialVersionUID = 1L;

	private TextField grammarNameText = new TextField(TestRigGuiQL.class
			.getPackage().getName() + ".QL");
	private TextField startNameText = new TextField("openForm");
	...
	public static void main(String[] args) throws Exception {
		TestRigGuiQL testRigGui = new TestRigGuiQL();
		testRigGui.setUpGui();
	}

	public TestRigGuiQL() throws Exception {
		super("TestRigGui");
	}
	...
	private void setUpGui() throws IOException, URISyntaxException {
		...
		URL resource = classLoader.getResource("example.ql");
