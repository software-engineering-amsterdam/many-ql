...
public class TestDivision extends BaseTest {
     ...
     public static Collection<Object[]> data() {
    	 return Arrays.asList(new Object[][] {
				...
				{ "form myForm { "
					...
					+ "	if(newQuestion / 5 == 5) {}"
					+ "}", true},
				// Identifier pointing to a string. Not allowed to divide.
				{ "form myForm { "
					+ "	newQuestion : string { \"String\" }"
					+ "	if(newQuestion / 5 == 5) {}"
					+ "}", false},
				// Identifier pointing to a boolean. Not allowed to divide.
				{ "form myForm { "
     ...
     public TestDivision(String input, boolean expected) {
