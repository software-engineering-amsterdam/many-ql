...
public class QLParser extends Parser {
	...
	public final QuestionNameContext questionName() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(55); ((QuestionNameContext)_localctx).Identifier = match(Identifier);
	...
	public final QuestionLabelContext questionLabel() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(58); match(StringLiteral);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case BANG:
				{
				setState(70); match(BANG);
				setState(71); expression(1);
				}
				break;
			case Identifier:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 12:
						...
						setState(110); match(MUL);
						setState(111); expression(4);
						}
						break;
					case 13:
						{
