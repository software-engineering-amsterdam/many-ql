...
public class QLSBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements QLSVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitQuestionIdent(QLSParser.QuestionIdentContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitTrueFalseIdentifier(QLSParser.TrueFalseIdentifierContext ctx) { return visitChildren(ctx); }
}