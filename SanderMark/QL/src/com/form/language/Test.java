...
public class Test {
	...
	//
	// //Check for undeclared variables, exit program and show errors if any
	// are found.
	// ErrorCollector varErrors =
	// CheckVariableErrors.containsUndeclaredVariables(ids, idTable);
	...
	// //Check for type errors, exit program and show errors if any are
	// found.
	...
	// CharStream charStream = new ANTLRInputStream("question" +
