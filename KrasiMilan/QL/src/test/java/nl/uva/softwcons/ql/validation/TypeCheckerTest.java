...
public class TypeCheckerTest {
    ...
    public void validateNoInitialErrors() {
        ...
        final List<Error> validationErrors = getCheckerErrors(TypeChecker::check, question);
    ...
    public void testInvalidExpressionOperandsReferringAQuestion() {
        ...
        final List<Error> validationErrors = getCheckerErrors(TypeChecker::check, question1, question2);
    ...
    public void testComplexFormWithMultipleErrors() {
        ...
        final List<Error> validationErrors = getCheckerErrors(TypeChecker::check, question1, question2, question3,
                ifStatement);
