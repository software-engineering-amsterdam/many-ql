...
public class QLSGrammarParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, T__26=27, BOOLEAN=28, TRUE=29, FALSE=30, ID=31, COLORENCODE=32, 
		NUMBER=33, STRING=34, COMMENT=35, WS=36;
	public static final int
		...
		RULE_type = 8, RULE_widgetType = 9, RULE_font = 10;
	public static final String[] ruleNames = {
		"stylesheet", "page", "section", "sectionBody", "question", "widget", 
		"defaultStyle", "styleProperty", "type", "widgetType", "font"
	};

	private static final String[] _LITERAL_NAMES = {
		null, "'stylesheet'", "'page'", "'{'", "'}'", "'section'", "'question'", 
		"'widget'", "'('", "','", "')'", "'default'", "'width:'", "'font:'", "'fontsize:'", 
		"'color:'", "'boolean'", "'number'", "'string'", "'checkbox'", "'spinbox'", 
		"'radio'", "'\"Arial\"'", "'\"Times New Roman\"'", "'\"Bazooka\"'", "'\"Book Antiqua\"'", 
		"'\"Courier\"'", "'\"Dialog\"'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		null, null, null, null, null, null, null, null, null, null, null, null, 
		null, null, null, null, null, null, null, null, null, null, null, null, 
		null, null, null, null, "BOOLEAN", "TRUE", "FALSE", "ID", "COLORENCODE", 
	...
	public static class FontNameContext extends StylePropertyContext {
		...
		public FontNameContext(StylePropertyContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterFontName(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitFontName(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitFontName(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ColorContext extends StylePropertyContext {
		...
		public ColorContext(StylePropertyContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterColor(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitColor(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitColor(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class WidthContext extends StylePropertyContext {
		...
		public WidthContext(StylePropertyContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterWidth(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitWidth(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitWidth(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class FontsizeContext extends StylePropertyContext {
		public TerminalNode NUMBER() { return getToken(QLSGrammarParser.NUMBER, 0); }
		public FontsizeContext(StylePropertyContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterFontsize(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitFontsize(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitFontsize(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NumberContext extends TypeContext {
		public NumberContext(TypeContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class CheckboxContext extends WidgetTypeContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterCheckbox(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitCheckbox(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitCheckbox(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SpinboxContext extends WidgetTypeContext {
		public SpinboxContext(WidgetTypeContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterSpinbox(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitSpinbox(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitSpinbox(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class RadioContext extends WidgetTypeContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterRadio(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitRadio(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitRadio(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DialogContext extends FontContext {
		public DialogContext(FontContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterDialog(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitDialog(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitDialog(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BazookaContext extends FontContext {
		public BazookaContext(FontContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterBazooka(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitBazooka(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitBazooka(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CourierContext extends FontContext {
		public CourierContext(FontContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterCourier(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitCourier(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitCourier(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BookAntiquaContext extends FontContext {
		public BookAntiquaContext(FontContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterBookAntiqua(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitBookAntiqua(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitBookAntiqua(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ArialContext extends FontContext {
		public ArialContext(FontContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterArial(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitArial(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitArial(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TimesNewRomanContext extends FontContext {
		public TimesNewRomanContext(FontContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).enterTimesNewRoman(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QLSGrammarListener ) ((QLSGrammarListener)listener).exitTimesNewRoman(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QLSGrammarVisitor ) return ((QLSGrammarVisitor<? extends T>)visitor).visitTimesNewRoman(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"