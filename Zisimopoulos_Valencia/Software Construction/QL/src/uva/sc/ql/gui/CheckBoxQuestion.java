...
public class CheckBoxQuestion extends Question {
    ...
    public CheckBoxQuestion(Map<String, List<String>> dependentElements, EvaluatorVisitor evalVisitor, List<Component> componentList) {
	...
	for (Entry<String, List<String>> entry : dependentElements.entrySet()) {
		...
		checkBox.addActionListener(new VisibilityListener(dependentElements, evaluator, componentList, checkBox));
	    }
	}
